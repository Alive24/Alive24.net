<template>
  <div class="flex flex-col lg:h-screen">
    ...
    <!-- Navbar -->
    <div class="navbar w-screen justify-between bg-base-100">
      <div class="navbar-start">
          ...
          <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
            <li tabindex="0">
              <NuxtLink to="/RealmDetail?realm=A">
                <a @click="activeRealm = 'A'">
                  <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" class="w-6 h-6 mr-1 stroke-[#2C3E50]">
        ...
        <NuxtLink to="/">
          <a class="btn btn-ghost normal-case text-lg lg:text-xl whitespace-nowrap">
            Alive的工作台
          </a>
        </NuxtLink>
      </div>
    ...
    <div class="items-center h-[100%] overflow-y-auto" style="scrollbar-width: thin;">
      ...
      <div class="flex justify-center prose-sm bg-transparent mt-[20px] text-xs gap-x-5">
        ...
        <a  class='h-[16px]' target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44030802000641">
          <img src="/image/gongan.png" style="float:left; height: 16px; margin: 0"/>
